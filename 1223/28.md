...
The UTT Aggressive 520W router has a critical overflow vulnerability. An attacker can control the parameters by accessing the route /goform/ConfigWirelessBase, which can cause a buffer overflow. Specifically, this can be done by "strcpy((char *)(InstPointByIndex + 24), src_1);"Implement a denial-of-service attack.

# Vulnerability details

The API for invoking the function

![image-20251229142856744](28/image-20251229142856744.png)

It can be found that there are many value operations here, among which we mainly focus on src

![image-20251229142952048](28/image-20251229142952048.png)

When src exists and is not 0, it will enter the if branch, and assigning src through strcpy will lead to the risk of buffer overflow

![image-20251229143008246](28/image-20251229143008246.png)
...
![image-20251118224225970](28/image-20251118224225970.png)